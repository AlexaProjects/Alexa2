			...
			try:
				...
				for component in reversed(zip(contours, hierarchy)):
					...
					if self.LookupLabelForIde is True:
						...
						if (w < 10 and h < 10 and self.Label.Position == "inside"):
							continue
				...
				if self.LookupLabelForIde is True:
					if len(self.AppObjectsForIde) > 0:
						...
						for appObj in self.AppObjectsForIde:
							if appObj[2] > retW and appObj[3] > retH and appObj[2] >= 3 and appObj[3] >= 3:
								retX = appObj[0]
								retY = appObj[1]
								retW = appObj[2]
								retH = appObj[3]
					...
					if self.LookupLabelForIde is True:
						if len(self.AppTextObjectsForIde) > 0:
							...
							for appText in self.AppTextObjectsForIde:
								if appText[2] > retW and appText[3] > retH and appText[2] >= 3 and appText[3] >= 3:
									retX = appText[0]
									retY = appText[1]
									retW = appText[2]
									retH = appText[3]
