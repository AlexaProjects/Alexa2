# -*- coding: utf-8 -*-
#
# Last Modified: 2013-09-08 by Alan Pipitone
...
HOME_NINJA_PATH = os.path.join(HOME_PATH, ".alexa_ide")
...
LOG_FILE_PATH = os.path.join(HOME_NINJA_PATH, 'alexa_ide.log')
...
IMAGES = {
    ...
    "icon": os.path.join(PRJ_PATH, "img", "alexaIcon.png"),
    "iconalexastart": os.path.join(PRJ_PATH, "addins", "qml", "img", "alexa-ide.png"),
    "iconalexaabout": os.path.join(PRJ_PATH, "img", "alexa-ide-about.png"),
    "iconalexaaboutsponsor": os.path.join(PRJ_PATH, "img", "sponsor-about.png"),
    "alexabindobjicon": os.path.join(PRJ_PATH, "img", "alexaBindObjInlineIcon.png"),
    "alexabindimgicon": os.path.join(PRJ_PATH, "img", "alexaBindImgInlineIcon.png"),
    "alexabindtexticon": os.path.join(PRJ_PATH, "img", "alexaBindTextInlineIcon.png"),
    "alexalogicon": os.path.join(PRJ_PATH, "img", "alexaLogInlineIcon.png"),
    "ninjaicon": os.path.join(PRJ_PATH, "img", "icon.png"),
    "iconUpdate": os.path.join(PRJ_PATH, "img", "alexaIcon.png"),
