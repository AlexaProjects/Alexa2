...
from ninja_ide.gui.dialogs import about_alexa
...
class MenuAbout(QObject):
    ...
    def __init__(self, menuAbout):
        ...
        aboutAlexaAction = menuAbout.addAction(self.tr("About AL'EXA-IDE"))
        ...
        self.connect(aboutAlexaAction, SIGNAL("triggered()"),
                        self._show_about_alexa)
    ...
    def _show_about_qt(self):
        QMessageBox.aboutQt(main_container.MainContainer(),
            self.tr("About Qt"))
    def _show_about_alexa(self):
        self.aboutAlexa = about_alexa.AboutAlexa(main_container.MainContainer())
        self.aboutAlexa.show()
