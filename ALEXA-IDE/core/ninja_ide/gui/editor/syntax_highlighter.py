...
def _create_scheme():
    scheme = {
      ...
      "syntax_alexa": dict(color=resources.CUSTOM_SCHEME.get(
          "alexa", resources.COLOR_SCHEME["alexa"]), italic=True),
      "syntax_alexa_region": dict(color=resources.CUSTOM_SCHEME.get(
          "alexa_region", resources.COLOR_SCHEME["alexa_region"]), bold=True),
      "syntax_alexa_objects": dict(color=resources.CUSTOM_SCHEME.get(
          "alexa_objects", resources.COLOR_SCHEME["alexa_objects"]), bold=False),
